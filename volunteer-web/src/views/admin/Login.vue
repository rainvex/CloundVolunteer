      ...
      <el-tab-pane label="邮箱登录" name="emailLogin">
        <el-form :model="loginUserForEmail" ref="loginForEmailRef" :rules="loginForEmailRules" label-width="150">
          ...
          <el-form-item style="height: 25px;">
            <span style="margin-left: 250px;"><router-link style="text-decoration: none;color: #1989fa" to="">忘记密码？</router-link></span>
          </el-form-item>
          <el-form-item>
      ...
      <el-tab-pane label="手机登录" name="phoneLogin">
        <el-form :model="loginUserForPhone" ref="loginForPhoneRef" :rules="loginForPhoneRules" label-width="150">
          <el-form-item label="手机号" prop="phone">
            <el-input v-model="loginUserForPhone.phone" placeholder="请输入手机号">
              <template #prefix>
...
.login-container {
  ...
  align-items: center;
  background: url("https://rainvex-1305747533.cos.ap-chengdu.myqcloud.com/blog/image/bg10.png") no-repeat fixed;
